...
def topic_extraction(request):
    ...
    #print("lda show topics", lda_model.show_topics(num_topics=10, num_words=10, log=False, formatted=True))
    ...
    return render(request, 'document_classification/results_page.html', {'topics_list':topics_list, 'topic_result':topic_result, 'documents':documents, 'topic_totals':topic_totals})
